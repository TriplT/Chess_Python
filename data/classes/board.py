...
class Board:
    ...
    def __init__(self):
        ...
        self.all_enemy_moves = [[0, 0, 0, 0, 0, 0, 0, 0] for rank in range(ranks)]
        self.pinned_squares = []
    ...
    def calculate_checks(self, color):
        self.calculate_all_enemy_moves('white' if color == 'black' else 'black')
    ...
    def calculate_enemy_attacking_moves(self, color):
            ...
            for possible_move_file in possible_move_files:
                if Square.in_range(possible_move_rank, possible_move_file):
                    if self.squares[possible_move_rank][possible_move_file].occupied_by_opponent(piece.color):
                        self.all_enemy_moves[possible_move_rank][possible_move_file] = 1
            ...
            for move in possible_moves:
                ...
                if Square.in_range(move_rank, move_file):
                    if self.squares[move_rank][move_file].no_friendly_fire(piece.color):
                        self.all_enemy_moves[move_rank][move_file] = 1
                    ...
                    if Square.in_range(possible_move_rank, possible_move_file):
                        if self.squares[possible_move_rank][possible_move_file].occupied_by_noone():
                            ...
                            if not pinned:
                                ...
                                enemy_piece = self.squares[possible_move_rank][possible_move_file].piece
                                if isinstance(enemy_piece, King) and enemy_piece.color != color:
                            ...
                            # give the en passant a square (rank, file) and
                    ...
                    if not left_rook.moved:
                        for c in range(1, 4):
                            ...
                            if c == 3:
                                ...
                                self.all_enemy_moves.append(move_king)
        ...
        self.all_enemy_moves = [] # clear list
        for rank in range(ranks):
            for file in range(files):
                if self.squares[rank][file].occupied_by_teammate(color):
                    piece = self.squares[rank][file].piece
